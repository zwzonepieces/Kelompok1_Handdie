...
class Pengguna extends CI_Controller{
        ...
        if(!empty($_FILES['filefoto']['name']))
        {
            if ($this->upload->do_upload('filefoto'))
            {
                    ...
                    if (empty($password) && empty($konfirm_password)) {
                    	$this->m_pengguna->update_pengguna_tanpa_pass($kode,$nama,$jenkel,$username,$password,$tentang,$email,$nohp,$alamat,$pemilik,$level,$gambar);
                		echo $this->session->set_flashdata('msg','info');
           				...
           				$this->m_pengguna->update_pengguna($kode,$nama,$jenkel,$username,$password,$tentang,$email,$nohp,$alamat,$pemilik,$level,$gambar);
                		echo $this->session->set_flashdata('msg','info');
           				redirect('admin/pengguna');
           			}
			...
			$level=$this->input->post('xlevel');
        	if (empty($password) && empty($konfirm_password)) {
               	$this->m_pengguna->update_pengguna_tanpa_pass_dan_gambar($kode,$nama,$jenkel,$username,$password,$tentang,$email,$nohp,$alamat,$pemilik,$level);
                echo $this->session->set_flashdata('msg','info');
           		redirect('admin/pengguna');
				}elseif ($password <> $konfirm_password) {
					echo $this->session->set_flashdata('msg','error');
           		...
           		$this->m_pengguna->update_pengguna_tanpa_gambar($kode,$nama,$jenkel,$username,$password,$tentang,$email,$nohp,$pemilik,$alamat,$level);
                echo $this->session->set_flashdata('msg','warning');
           		redirect('admin/pengguna');
           	}
        } 
    ...
    function get_edit_admin(){
        ...
        $x['data']=$this->m_pengguna->get_pengguna_by_kode($kode);
        $x['kat']=$this->m_kategori->get_all_kategori();
        $this->load->view('admin/v_edit_pengguna_admin',$x);
    }
